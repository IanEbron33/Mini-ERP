...
## 3. Currency System: Philippine Peso (`₱` / `PHP`)
...
## 4. Performance & Caching Engine: SWR In-Memory Cache ([lib/cache/swr-cache.ts](file:///c:/Users/ADMIN/Desktop/Folder1/mini-erp-app/lib/cache/swr-cache.ts))
...
* **Targeted Mutation Invalidation (`invalidateCache`)**:
  ...
  * Stock adjustments & product edits immediately purge and refresh `'catalog_products'`, `'admin_sales_data'`, `'admin_dashboard_metrics'`, and `'admin_finance_ledger'`.
* **Manual Refresh Bypass**: Each page's `[ Refresh ]` button forces a direct, synchronous database re-fetch on demand.

---

## 5. Authentication & Multi-Portal Architecture
...
### 5. Inventory & Product Suite ([app/inventory/catalog/page.tsx](file:///c:/Users/ADMIN/Desktop/Folder1/mini-erp-app/app/inventory/catalog/page.tsx))
...
* **Low Stock & Restock Workflow** ([app/inventory/low-stock/page.tsx](file:///c:/Users/ADMIN/Desktop/Folder1/mini-erp-app/app/inventory/low-stock/page.tsx)): Filtered low-stock directory with 1-click supplier restock modal using valid enum `"Supplier Addition"`.
...
## 7. Strict User Preferences (`agent/SKILLS.md`)
